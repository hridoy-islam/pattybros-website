    ...
    >
      <div className="flex items-center gap-3 select-none">
        ...
        <span className="text-primary-foreground font-black text-xs uppercase tracking-[0.25em]">
          <h4>THE HOME OF PREMIUM SMASH BURGERS IN LONDON</h4>
        </span>
      </div>
      
      <h2 className="text-3xl md:text-4xl font-extrabold uppercase tracking-tight scale-y-105 origin-left select-none leading-none">
        Quality British Aged Beef.<br/>
        <span className="text-primary-foreground">Bold Flavours.</span>
      </h2>
      
      <h4 className="text-zinc-700 text-sm md:text-base font-medium leading-relaxed pt-2">
        We use quality British aged beef, carefully sourced ingredients and bold flavours inspired by Britain's love of proper comfort food.
      </h4>
      
      <h4 className="text-zinc-700 text-xs md:text-sm leading-relaxed">
        Every burger starts with carefully selected beef smashed on a hot griddle to create the crispy edges that smash burger fans love. Combined with melted cheese, fresh toppings, toasted potato buns and our signature sauces, every bite delivers the perfect balance of crunch, juiciness and flavour.
      </h4>

      <h4 className="text-zinc-700 text-xs md:text-sm leading-relaxed">
        Located in South East London, Patty Bros has quickly become a destination for burger lovers looking for authentic smash burgers, loaded fries and quality street food made properly. Whether you're dining in, ordering takeaway, booking catering or searching for the best smash burger in London, Patty Bros delivers fresh food, fast service and unforgettable flavour.
      </h4>
      ...
      <div className="grid grid-cols-3 gap-4 pt-6 border-t border-zinc-100">
        <div>
          ...
          <h4 className="text-zinc-700 text-[10px] md:text-xs font-bold uppercase tracking-wider mt-0.5">British Aged Beef</h4>
        </div>
        <div>
          <h3 className="text-2xl md:text-3xl font-black text-zinc-900">Fresh</h3>
          <h4 className="text-zinc-700 text-[10px] md:text-xs font-bold uppercase tracking-wider mt-0.5">Smashed Daily</h4>
        </div>
        <div>
          <h3 className="text-2xl md:text-3xl font-black text-zinc-900">Crispy</h3>
          <h4 className="text-zinc-700 text-[10px] md:text-xs font-bold uppercase tracking-wider mt-0.5">Seared Edges</h4>
        </div>
      </div>
    </motion.div>
    ...
    >
      <div className="relative aspect-[4/5] w-full rounded-sm overflow-hidden shadow-2xl bg-zinc-100 border border-zinc-200/40">
        <Image 
          ...
          alt="Premium smash burger with crispy edges"
          fill
        ...
        <div className="absolute bottom-6 left-6 bg-zinc-950 text-white p-5 rounded-sm flex items-center gap-4 border border-zinc-800 shadow-xl backdrop-blur-md bg-opacity-95">
          ...
          <div>
            <p className="text-[10px] font-black tracking-widest text-zinc-400 uppercase">South East</p>
            <p className="text-base font-extrabold text-white tracking-tight">LONDON</p>
          </div>
        </div>
      </div>
    </motion.div>
